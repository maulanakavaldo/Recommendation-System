                                    ...
                                    <?php foreach ($prodi as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= site_url('prodi/ubah/' . $row->id_prodi) ?>" class="btn btn-success btn-xs" title="Ubah">Ubah</a>
                                                <a href="#" data-href="<?php echo site_url('prodi/hapus/' . $row->id_prodi); ?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-xs" title="Hapus">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
