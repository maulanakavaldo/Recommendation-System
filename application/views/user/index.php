    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">User Penilaian</h3>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-block">
                        <h4 class="card-title">Data User Penilaian</h4>
                        <div class="card-subtitle"><?= anchor('user/tambah', 'Tambah Data', 'class="btn btn-primary"') ?></div>
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="dataTables1">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>User Penilaian</th>
                                        <th width="15%">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($user as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row->nama_user ?></td>
                                            <td>
                                                <a href="<?= site_url('user/ubah/' . $row->id_user) ?>" class="btn btn-success btn-xs" title="Ubah">Ubah</a>
