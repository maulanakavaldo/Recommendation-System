                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-subtitle">
                            <?= anchor('nilai/tambah', 'Tambah Data', 'class="btn btn-primary"') ?>
                            <?= anchor('nilai/prioritas', 'Prioritas Nilai', 'class="btn btn-info"') ?>
                        </div>
                            ...
                            <table class="table table-striped table-bordered" id="dataTables1">
                                ...
                                <tbody>
                                    <?php foreach ($nilai as $row) : ?>
                                        <tr>
                                            <td></td>
                                            <!-- <td><? //= $row->nilai_1 . ' - ' . $row->batas_2 
                                                        ?></td> -->
                                            <td class="text-center"><?= $row->nilai_1 ?></td>
                                            <td class="text-center"><?= $row->nama ?></td>
                                            <td class="text-center"><?= $row->prioritas ?></td>
                                            <td class="text-center">
                                                <a href="<?= site_url('nilai/ubah/' . $row->id_nilai) ?>" class="btn btn-success btn-xs" title="Ubah">Ubah</a>
                                                <a href="#" data-href="<?php echo site_url('nilai/hapus/' . $row->id_nilai); ?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-xs" title="Hapus">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
