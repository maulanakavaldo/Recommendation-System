            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-block">
                        ...
                        <?= form_open('fakultas/tambah', 'class="form-horizontal form-material"') ?>
                        <?= $this->session->flashdata('success') ?>
                        <div class="form-group">
                            <label class="col-md-12">Fakultas</label>
                            <div class="col-md-12">
                                <input type="text" name="nama_fakultas" class="form-control form-control-line" value="<?= set_value('nama_fakultas') ?>">
                                <!-- <input type="text" name="jumlah_prodi" class="form-control form-control-line" value="<? //= set_value('jumlah_prodi') 
                                                                                                                            ?>"> -->
