...
class Password extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('password', 'Password Lama', 'trim|required|callback_cek_password_lama', array('required' => '%s tidak boleh kosong!',));
        $this->form_validation->set_rules('password_baru', 'Password Baru', 'trim|required', array('required' => 'Isi dulu %s',));
        $this->form_validation->set_rules('ulangi', 'Ulangi Password Baru', 'trim|required|matches[password_baru]', array('required' => '%s tidak boleh kosong!', 'matches' => 'Password tidak sama!',));
