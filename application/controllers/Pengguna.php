...
class Pengguna extends CI_Controller
{
    ...
    {
        $data['pengguna'] = $this->pengguna_model->get_pengguna($id_admin)->row();
        ...
        if (empty($data['pengguna'])) {
            ...
            if ($this->form_validation->run()) {
                ...
                $this->pengguna_model->update_pengguna($id_admin, $params);

                $this->session->set_flashdata('success', '<div class="alert alert-success" role="alert">Data berhasil diubah</div>');
                redirect('pengguna');
                // redirect('pengguna/ubah/' . $id_admin);
            } else {
                // $this->session->set_flashdata('failure', '<div class="alert alert-danger" role="alert">Data gagas disimpan</div>');
